...
public class TestEntity extends PersistentEntity<TestEntity.Cmd, TestEntity.Evt, TestEntity.State> {
  ...
  public static class Get implements Cmd, CorePersistentEntity.ReplyType<State> {
  ...
  public static class Add implements Cmd, CorePersistentEntity.ReplyType<Evt> {
  ...
  public static class ChangeMode implements Cmd, CorePersistentEntity.ReplyType<Evt> {
